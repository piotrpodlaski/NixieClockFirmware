...
const std::map<std::pair<uint8_t,uint8_t>,uint8_t> nixieDigitMapping{
...
const std::map<std::pair<uint8_t,uint8_t>,uint8_t> nixieDpMapping{
...
const std::vector<uint8_t> neonTubes{0+6*8, 1+6*8};
